...
//GEOMANAGER Layers by Oleg Smetanint typedef
declare module L {
...
declare module L{
    ...
    export interface GoogleLayer extends L.TileLayer {

        /**
          * The position of the control (one of the map corners). See control positions.
          * Default value: 'bottomright'.
          */
        options?: L.GoogleOptions;

        /**
          * The HTML text shown before the attributions. Pass false to disable.
          * Default value: 'Powered by Leaflet'.
          */
        initialize(type: string, options:L.GoogleOptions );

    }
}
declare module L {
    export interface BingOptions {
        subdomains?: Array<number>;//[0, 1, 2, 3],
        type?: string;// 'Aerial',
...
declare module L {
    export function BingLayer(): void
    ...
    export interface BingLayer extends L.TileLayer {
        ...
        /**
          ...
          * Default value: 'bottomright'.
          */
        options?: L.BingOptions;

        /**
          * The HTML text shown before the attributions. Pass false to disable.
          * Default value: 'Powered by Leaflet'.
          */
        initialize(key: string, options: L.BingOptions);
